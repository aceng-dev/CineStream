...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 2; // Naikkan versi ke 2
    ...
    public static final String COL_URL_TRAILER = "url_trailer";       // Tambahkan ini
    ...
    public boolean addToWatchlist(String idApi, String judul, String poster, String trailer) {
        ...
        values.put(COL_URL_TRAILER, trailer); // Simpan URL Trailer
    ...
    public ArrayList<HashMap<String, String>> getAllWatchlist() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                map.put(COL_URL_TRAILER, cursor.getString(cursor.getColumnIndexOrThrow(COL_URL_TRAILER)));
